...
(window.locales = window.locales || {}).flappy_locale = {
  ...
  shareFlappyTwitterDonor: function(d) { return "Check out the Flappy game I made. (Thanks " + d.donor + " for supporting @codeorg)"; },
