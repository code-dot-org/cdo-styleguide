...
(window.locales = window.locales || {}).studio_locale = {
  ...
  addGoalPosition: function(d) { return "add goal to the %1 position"; },
  ...
  calloutBlocklyPlaceMoveUpHere: function(d) { return "Place a \"move droid up\" block here to move up"; },
  ...
  collidesWithAnySpriteName: function(d) { return "collides with any " + d.spriteName; },
  ...
  extraFunction: function(d) { return "You have renamed a function to " + d.funcName + " but it won't work. You should use the original function name."; },
  ...
  hoc2015_reinfFeedbackMsg: function(d) { return "You can press the \"" + d.backButton + "\" button to go back to playing your game."; },
  ...
  ifDroidN: function(d) { return "droid " + d.spriteIndex; },
  ifSprite: function(d) { return "actor"; },
  ifSpriteN: function(d) { return "actor " + d.spriteIndex; },
  ...
  localFunction: function(d) { return "You have placed " + d.funcName + " inside another function. You should move " + d.funcName + " to a different location in your program."; },
  ...
  moveSpriteN: function(d) { return "move actor " + d.spriteIndex; },
  moveDroid: function(d) { return "move droid"; },
  moveDroidN: function(d) { return "move droid " + d.spriteIndex; },
  ...
  reinfFeedbackMsg: function(d) { return "You can press the \"" + d.backButton + "\" button to go back to playing your story."; },
  ...
  saySpriteN: function(d) { return "actor " + d.spriteIndex + " say"; },
  ...
  scoreText: function(d) { return "Score: " + d.playerScore; },
  ...
  setEverySpriteNameChaseActor: function(d) { return "set every " + d.spriteName + " to chase actor"; },
  setEverySpriteNameFleeActor: function(d) { return "set every " + d.spriteName + " to flee actor"; },
  setEverySpriteNameSpeed: function(d) { return "set every " + d.spriteName + " speed"; },
  setEverySpriteNameWander: function(d) { return "set every " + d.spriteName + " to wander"; },
  ...
  shareStudioTwitterDonor: function(d) { return "Check out the story I made. (Thanks " + d.donor + " for supporting @codeorg)"; },
  ...
  setPosition: function(d) { return "set to the %1 position"; },
  setSprite: function(d) { return "set"; },
  setSpriteN: function(d) { return "set actor " + d.spriteIndex; },
  setSpritePosition: function(d) { return "set actor %1 to the %2 position"; },
  setDroidN: function(d) { return "set droid " + d.spriteIndex; },
  ...
  stopEverySpriteName: function(d) { return "stop every " + d.spriteName; },
  stopSprite: function(d) { return "stop"; },
  stopSpriteN: function(d) { return "stop actor " + d.spriteIndex; },
  stopDroid: function(d) { return "stop droid"; },
  stopDroidN: function(d) { return "stop droid " + d.spriteIndex; },
  ...
  throwSpriteN: function(d) { return "actor " + d.spriteIndex + " throw"; },
  throwTooltip: function(d) { return "Throws a projectile from the specified actor."; },
  toSet: function(d) { return "to set"; },
  toTouchedSpriteName: function(d) { return "to touched " + d.spriteName; },
  ...
  vanishActorN: function(d) { return "vanish actor " + d.spriteIndex; },
  ...
  whenDroidClickedN: function(d) { return "when droid " + d.spriteIndex + " clicked"; },
  ...
  whenSpriteClickedN: function(d) { return "when actor " + d.spriteIndex + " clicked"; },
  whenSpriteClickedTooltip: function(d) { return "Execute the actions below when an actor is clicked."; },
  whenSpriteCollidedN: function(d) { return "when actor " + d.spriteIndex; },
  ...
  whenSpriteCollidedWithN: function(d) { return "touches actor " + d.spriteIndex; },
  ...
  whenSpriteN: function(d) { return "when actor " + d.spriteIndex; },
