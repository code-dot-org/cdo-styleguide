...
"deleteAccount_teacherWarning1":function(d){return "Deleting your account will permanently erase all personal information, coursework, and projects connected to this account after 28 days. It will also "},
...
"deleteAccount_teacherWarning4":function(d){return "Give these students a chance to keep using their Code.org accounts by "},
...
"deleteAccountDialog_body1":function(d){return "WARNING: "},
"deleteAccountDialog_body2":function(d){return "Deleting your account will "},
"deleteAccountDialog_body3":function(d){return "permanently erase "},
"deleteAccountDialog_body4":function(d){return "all your personal information, coursework, and projects linked to this account after 28 days. "},
"deleteAccountDialog_body5":function(d){return "It will also "},
"deleteAccountDialog_body6":function(d){return "permanently delete your students’ accounts "},
"deleteAccountDialog_body7":function(d){return "accounts unless they created a personal login."},
"deleteAccountDialog_checkboxPreface":function(d){return "I understand that by deleting my account, "},
"deleteAccountDialog_checkboxTitle":function(d){return "Please verify the following statements before you can delete your account:"},
"deleteAccountDialog_checkbox1_1":function(d){return "I have the authority to delete the education "},
"deleteAccountDialog_checkbox1_2":function(d){return "records of the students in my sections (or release it to them, if they have a personal login)."},
...
"deleteAccountDialog_checkbox3":function(d){return "my students’ accounts may also be permanently deleted."},
"deleteAccountDialog_checkbox4":function(d){return "my students may not be able to access their accounts anymore."},
"deleteAccountDialog_checkbox5":function(d){return "the projects and creations of my students may also be deleted."},
"deleteAccountDialog_studentButton":function(d){return "Delete my Account"},
"deleteAccountDialog_teacherButton":function(d){return "Delete my and my students' accounts"},
...
"deleteAccountDialog_emailUs":function(d){return "If you delete your account and change your mind, you can email us at support@code.org within 28 days to recover your account."},
...
"personalLoginDialog_body1":function(d){return "Deleting your account will also delete your students’ accounts "},
"personalLoginDialog_body2":function(d){return "unless they created a personal login for their accounts."},
...
"removeStudentAndRecordsHeader":function(d){return "Remove "+common_locale.v(d,"studentName")+" and release their education records?"},
"removeStudentBody1":function(d){return "Make sure you have authority from the school to release this student’s education records"},
"removeStudentBody2":function(d){return "before removing them from your section. If the student is not in a teacher’s section, they will be in full control of their data and have the ability to delete their account, including their course progress and projects."},
"removeStudentBody3":function(d){return "This student will no longer be able to sign in to their account once you remove them. Please give your student a chance to keep using their Code.org account by allowing them to create a personal login."},
"removeStudentBody4":function(d){return "Give them at least a few days to follow these instructions before you remove them."},
...
"wrongCourseVersionWarningDetails":function(d){return "We noticed you have progress in an older version of this course. You can go back to this version any time by using the dropdown below to select the version of the course you want."},
"wrongUnitVersionWarningDetails":function(d){return "We noticed you have progress in an older version of this course. You can go back to this version any time by going to the course page and selecting the version of the course you want."},
